...
public class Option4Activity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        findViewById(R.id.btn_prev4).setOnClickListener(onClickListener);
    }
            ...
            public void onClick(View v) {
                switch (v.getId()) {
                    case R.id.btn_process_4:
                        ...
                        break;
                    case R.id.btn_next4:
                        startActivity(new Intent(getApplicationContext(),Option5Activity.class));
                        break;
                    case R.id.btn_prev4:
                        startActivity(new Intent(getApplicationContext(),Option3Activity.class));
                        break;
                }
                hideKeyboardInput(v);
            }
